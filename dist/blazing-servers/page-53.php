...
//    'walker'          => '',
        ...
        <div class="container">
            ...
            <h4 class="home-description" >
                We offer top of the line hardware for all of your dedicated server needs. Our dedicated servers can be
                customized to your exact needs so you know you are getting exactly what you want!
            </h4>
            ...
            <div class="package-row ">
                ...
                <div class="package">
                    ...
                    <ul class="package-description-list">
                        ...
                        <li>
                            <p>Locations</p>
                            <p>Los Angeles, Dallas, Buffalo, Chicago</p>
                        </li>
                    ...
                    <div class="package-btn-wrap">
                        <a href="#server-configuration" class="standard-package-btn package-btn package-buy-btn"
                           onclick="change_package('Standart')">Configure</a>
                    </div>
                </div>
                ...
                <div class="package">
                    ...
                    <div class="package-btn-wrap">
                        <a href="#server-configuration" class="enhanced-package-btn package-btn package-buy-btn"
                           onclick="change_package('Enchanced');">Configure</a>
                    </div>
                </div>
                ...
                <div class="package">
                    ...
                    <div class="package-btn-wrap">
                        <a href="#server-configuration" class="enterprise-package-btn package-btn package-buy-btn"
                           onclick="change_package('Enterprise')">Configure</a>
                    </div>
                </div>
...
<section class="personal-configuration-section">
    ...
    <form action="https://billing.blazingseollc.com/hosting/index.php?m=whmcs_templates_adjustments&method=addProductToCart&pid=1846"
          METHOD="get">
        ...
        <div class="container">
            ...
            <div id="server-configuration" class="left-side">
                ...
                <div class="input-group desktop-view">

                    <h4 class="input-header">Speed</h4>

                    <div class="blank-select" >
                            <span value="arrow-none">1 Gbps</span>
                ...
                <div class="input-group desktop-view">
                    ...
                    <h4 class="input-header">USA Support</h4>

                    <div class="blank-select" >
                        <span value="arrow-none">24/7/365</span>
                ...
                <p class="left-info">
                    We strive to have your server ready as soon as possible. However please allow up to 12 hours for
                    delivery.
                </p>
                ...
                <div class="package" >
                    ...
                    <div class="padding-box" >
                        ...
                        <ul class="package-description-list">
                            ...
                            <li>
                                <p>CPU</p>
                                <p>E3-1240v5 <span class=" extra-price-span ">($64)</span></p>
                            </li>

                            <li>
                                <p>RAM</p>
                                <p><span class="total-ram">8 </span> GB <span class="extra-price-span ">($<span
                                                class="ram-extra-price-span">13</span>)</span></p>
                            </li>


                            <li>
                                <p>Hard Drive</p>
                                <p><span class="total-ssd">128 </span> GB <span class=" extra-price-span ">($<span
                                                class="ssd-extra-price-span">13</span>)</span></p>
                            </li>
                            <li>
                                <p>Locations</p>
                                <p><span class="total-country">Los Angeles </span></p>
                            </li>

                            <li style="border-bottom: 1px solid #cfdbef;">
                                <p>OS</p>
                                <p><span class="total-os">Windows 2012 R2 </span></p>
                            </li>


                            <li style="border-bottom: 1px solid #cfdbef;">
                                <p>Setup Fees</p>
                                <p>One Time <span class=" extra-price-span ">($10)</span></p>
                            </li>


                            <li>
                                <p class="total-price-label" style="width: 100%;">First Month Payment</p>
                            </li>
                        </ul>
                        ...
                        <div class="package-btn-wrap">
                            ...
                            <input type="submit" value="Buy" class="package-btn package-buy-btn"/>
                        </div>
                    </div>
                    ...
                    <div class="package-footer desktop-view">

                        <p>
                            Monthly Payment

                        </p>
                        <p class="monthly-price-span-wrap">
                            $<span class="monthly-price-span">90</span>
                        </p>
...
<section class="benefit-section">
    ...
    <div class="container">
        ...
        <p class="benefits-section-description">
            We offer everything you need from a server provider! Blazing SEO offers you fast speeds, top of the line
            hardware, and unmatched customer support to ensure the best experience for you!
    ...
    <div class="container">
        ...
        <div class="faq-item">
            ...
            <div class="panel-body">Our servers are all set up on dedicated 1 Gbps Ethernet ports.
                If you are not seeing 1 Gbps on for your connection, please see <a
                        href="http://support.blazingseollc.com/support/solutions/articles/19000045816-why-do-i-get-low-speed-test-results-">this
                    article</a> from our support site.
        ...
        <div class="faq-item">
            ...
            <div class="panel-body">We strive to have your server ready as soon as we possibly can. Usually this will
                happen in 4 hours or less. However, please allow up to 12 hours for us to complete the setup for your
                dedicated server.
            </div>
        </div>

...
$(document).ready(function() {
    ...
    if (urlParse[urlParse.length - 1] == '#standard') {
        ...
        $(".standard-vps-package").click();

        // Scroll
        $('html,body').animate({
            scrollTop: (($(".standard-vps").offset().top) -30 )
        }, 'slow');
    ...
    if (urlParse[urlParse.length - 1] == '#enhanced') {
        ...
        $(".enhanced-vps-package").click();

        // Scroll
        $('html,body').animate({
            scrollTop: (($(".enhanced-vps").offset().top) -30  )
        }, 'slow');
    ...
    if (urlParse[urlParse.length - 1] == '#enterprise') {
        ...
        $(".enterprise-vps-package").click();

        // Scroll
        $('html,body').animate({
            scrollTop: (($(".enterprise-vps").offset().top) -30)
        }, 'slow');
